 ...
 *
 * Demos:
 * - [Clientele1](https://www.Capitalta.io/blocks/clientele/clientele1)
 *
 * API:
 * - [Clientele1 API](https://capitalta.gitbook.io/Capitalta/ui-kit/development/components/clientele/clientele1#props-details)
 */
  ...
  return (
    <ContainerWrapper sx={{ py: SECTION_COMMON_PY }}>
      <Grid container spacing={{ xs: 2.5, sm: 1.5 }} sx={{ alignItems: 'center' }}>
        ...
        <Grid sx={{ '.slick-track': { alignItems: 'center' } }} size={{ xs: 12, sm: 9 }}>
