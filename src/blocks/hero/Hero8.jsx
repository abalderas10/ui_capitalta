          ...
          {listData.map((item, index) => (
            <Grid
              ...
              sx={{
                px: { xs: 2, md: 5 },
                py: { xs: 2, md: 0 },
                ...(index < indexOfFirstElementInLastRow && { borderBottom: `1px solid ${theme.vars.palette.divider}` }),
                ...(!indicesOfLastElements.includes(index) && { borderRight: `1px solid ${theme.vars.palette.divider}` })
              }}
            >
