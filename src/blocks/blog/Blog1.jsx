 ...
 *
 * Demos:
 * - [Blog1](https://www.Capitalta.io/blocks/blog/blog1)
 *
 * API:
 * - [Blog1 API](https://capitalta.gitbook.io/Capitalta/ui-kit/development/components/blog/blog1#props-details)
 */
              ...
              {blogs.map((item, index) => (
                <Box key={index} sx={{ px: { xs: 0.25, sm: 0.5, md: 0.75 } }}>
                  <GraphicsCard
                    ...
                    overLay={`linear-gradient(360deg, ${withAlpha(theme.vars.palette.grey[900], 0.5)} 0%, ${withAlpha(theme.vars.palette.primary.darker, 0)} 100%)`}
                  >
