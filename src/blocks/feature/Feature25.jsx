 ...
 *
 * Demos:
 * - [Feature25](https://www.Capitalta.io/blocks/feature/feature25)
 *
 * API
 * - [Feature25 API](https://capitalta.gitbook.io/Capitalta/ui-kit/development/components/feature/feature25#props-details)
 */
            ...
            <GraphicsCard sx={{ width: { xs: 1, sm: 'unset' }, bgcolor: 'unset', border: '1px solid', borderColor: 'grey.300' }}>
              <Box sx={{ p: 0.25 }}>
                <TabList
                  ...
                  slotProps={{ indicator: { sx: { display: 'none' } }, list: { sx: { gap: 0.25 } } }}
                  variant="scrollable"
                >
