    ...
    <>
            ...
            <Grid item xs={12} md={7}>
              <Stack spacing={2}>
                ...
                <Typography variant="body1" sx={{ maxWidth: 600 }}>
                  Impulsa tu operación con un crédito diseñado para crecer contigo, acompañando las necesidades de inversión, expansión o
                  refinanciamiento de tu empresa.
                </Typography>
              ...
              >
                <Stack spacing={1.5}>
                  ...
                  <Stack direction="row" sx={{ justifyContent: 'space-between' }}>
                    ...
                    <Typography variant="body2">$20,000 - $50,000,000 MXN</Typography>
                  </Stack>
                  <Stack direction="row" sx={{ justifyContent: 'space-between' }}>
          ...
          <Grid item xs={12} md={7}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                Empresas en expansión, negocios que buscan reforzar su infraestructura, modernizar sus activos o consolidar obligaciones
                financieras en un solo esquema.
              </Typography>
            </Stack>
          </Grid>
          <Grid item xs={12} md={5}>
            ...
            <Stack spacing={2}>
              ...
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Stack spacing={1}>
                      <Typography variant="subtitle1">Actividad formal con mínimo 1 año</Typography>
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        Operación formal y comprobable con al menos un año de historial.
                      </Typography>
                    </Stack>
                  </Box>
                </Grid>
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Stack spacing={1}>
                      ...
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        Estados financieros e información que respalden la capacidad de pago de la empresa.
                      </Typography>
                    </Stack>
                  </Box>
                </Grid>
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Stack spacing={1}>
                      ...
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        Inmueble que respalde la operación y pueda ser afecto en garantía según el análisis de Capitalta.
                      </Typography>
                    </Stack>
                  </Box>
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Stack spacing={1}>
                      ...
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        Desde $20,000 hasta $50,000,000 MXN, considerando hasta el 50% del valor del inmueble en garantía.
                      </Typography>
                    </Stack>
                  </Box>
                </Grid>
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Stack spacing={1}>
                      ...
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        De 1 a 120 meses, en función de la naturaleza del proyecto y el flujo de la empresa.
                      </Typography>
                    </Stack>
                  </Box>
                </Grid>
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Stack spacing={1}>
                      ...
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        Mantén visibilidad sobre tus pagos con una tasa estable durante toda la vida del crédito.
                      </Typography>
                    </Stack>
                  </Box>
                </Grid>
                <Grid item xs={12} sm={6}>
                  ...
                  >
                    <Stack spacing={1}>
                      ...
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                        Posibilidad de adelantar pagos o liquidar anticipadamente sin cargos por penalización.
                      </Typography>
                    </Stack>
                  </Box>
                </Grid>
      ...
      <ContainerWrapper>
        <Grid container spacing={4} sx={{ mb: { xs: 4, sm: 6 } }}>
          <Grid item xs={12} md={5}>
            <Stack spacing={2.5}>
              <Typography variant="h4">Calcula tu Crédito Empresarial</Typography>
              <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                Ingresa un monto, plazo y tasa anual estimada para proyectar un pago mensual aproximado. Estos resultados son informativos y
                pueden ajustarse tras el análisis de Capitalta.
              </Typography>
              <TextField
              ...
              <Stack direction="row" spacing={2}>
                ...
                <Button variant="outlined" color="primary" href="/calculadoras/calculadora-empresarial">
          ...
          <Grid item xs={12} md={7}>
            <Stack spacing={2.5}>
              ...
              <Typography variant="caption" sx={{ color: 'text.secondary' }}>
                Para una simulación detallada, con tabla completa y descarga en PDF, utiliza la calculadora avanzada de Crédito Empresarial.
              </Typography>
            </Stack>
          </Grid>
        </Grid>
        ...
        >
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={12} md={8}>
              <Stack spacing={1}>
                <Typography variant="h5">¿Listo para escalar tu empresa?</Typography>
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Acércate a Capitalta para estructurar un Crédito Empresarial alineado a la realidad de tu negocio y sus proyecciones de
                  crecimiento.
                </Typography>
              </Stack>
            </Grid>
            <Grid item xs={12} md={4}>
              <Stack direction="row" spacing={2} sx={{ justifyContent: { xs: 'flex-start', md: 'flex-end' } }}>
                <Button variant="contained" color="primary" href="/auth/registro">
                  Solicitar Crédito Empresarial ahora
                </Button>
